...
- (void)drawRect:(CGRect)rect {
    ...
    if (_showProgressText) {
        ...
        CGRect addr = CGRectMake((CircleSelfWidth-stringSize.width)/2.0, (CircleSelfHeight - stringSize.height)/2.0-20,stringSize.width, stringSize.height);
        [currentText drawInRect:r withAttributes:attributes];
        [addText drawInRect:addr withAttributes:attributes];
    }
